...
const ALL_TYPES = ['TRAITEUR', 'EPICERIE_FINE'];
...
export default function AllOrdersPage() {
  ...
  }, [page, typeFilter, statusFilter, search, dateFrom, dateTo, sortBy, sortOrder, headers]);
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Toutes les commandes traiteur et épicerie fine
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Commandes du jour</p>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">CA du jour</p>
            </div>
            <p className="text-2xl font-bold text-[#D4A017]">{formatPrice(stats.todayRevenue)}</p>
          </div>
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-1">
              <PieChart size={16} className="text-purple-500" />
              <p className="text-xs text-gray-500 dark:text-gray-400">Répartition</p>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <span className="font-semibold text-gray-900 dark:text-white">
                {stats.typeBreakdown.TRAITEUR || 0}
              </span>
              <span className="text-gray-400">T</span>
              <span className="text-gray-300 dark:text-gray-600">|</span>
              <span className="font-semibold text-gray-900 dark:text-white">
                {stats.typeBreakdown.EPICERIE_FINE || 0}
              </span>
  ...
  return (
    <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300">
      ...
      >
        ...
        <ArrowUpDown
          size={14}
          className={active ? 'text-[#D4A017]' : 'text-gray-400'}
