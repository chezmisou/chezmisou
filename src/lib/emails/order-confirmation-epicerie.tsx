...
export function OrderConfirmationEpicerie({
  firstName,
  orderNumber,
  items,
  subtotal,
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Votre commande N° <strong>{orderNumber}</strong> est bien
              reçue. Misou prépare votre colis avec amour…
            </Text>
            ...
            <table style={totalsTable} cellPadding="0" cellSpacing="0">
              <tbody>
                ...
                <tr>
                  <td style={totalLabel}>Frais de port</td>
                  <td style={totalValue}>
                    {shippingCost === 0
                      ? "Offerts !"
