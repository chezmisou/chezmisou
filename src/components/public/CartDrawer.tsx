    ...
    <div className="fixed inset-0 z-[60]">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-marron-profond/10">
          <h2 className="font-playfair text-xl text-marron-profond">
            Votre panier
          </h2>
          <button
            onClick={closeCart}
                ...
                <div className="flex flex-col items-end justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="w-6 h-6 rounded-full border border-marron-profond/20 text-xs flex items-center justify-center hover:bg-white transition-colors"
                    >
                      −
                    </button>
        ...
        {items.length > 0 && (
          <div className="border-t border-marron-profond/10 px-6 py-4 space-y-3">
            ...
            <Link
              ...
              onClick={closeCart}
              className="block w-full py-3 rounded-xl bg-marron-profond text-blanc-creme font-semibold text-center hover:bg-marron-profond/90 transition-colors"
            >
              Passer commande
            </Link>
          </div>
